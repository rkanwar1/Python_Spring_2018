...
## Description:  
This workshop series will provide an overview of Python programming and some widely-used Python packages.  It is targeted at participants with prior experience programming in another language, but who wish to get up and running with Python. This course will not cover “how to program” – we that expect you have prior experience in another programming language, and that you want to transition to using Python.
