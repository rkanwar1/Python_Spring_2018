...
print(' ')
print('Displaying odd numbers in the range [1,10]')
countup_odd(10)

print(' ')
print('Displaying even numbers in the range [1,14]')
countdown_even(14)

print(' ')
print('Displaying n! for all numbers in the range [1,20]')
display_factorials(20)
